...
class UserFollowServiceTest {
    ...
    void postUserFollow() {
        //given
        //authenticationFacade Mock 객체의 getSignedUserId() 메소드를 호출하면 willReturn 값이 리턴이 되도록 세팅
        final int EXPECTED_RESULT = 13;
        given(authenticationFacade.getSignedUserId()).willReturn(fromUserId1);

        final UserFollowReq givenParam1_2 = new UserFollowReq(toUserId2);
    ...
    void deleteUserFollow() {
        ...
        final UserFollowReq givenParam = new UserFollowReq(TO_USER_ID);
